...
if __name__== "__main__":
   ...
   # unigram presentation
    ...
    error_number_online_unigram2 = np.mean(np.array(error_number1))
    error_rate_online_unigram2 = error_number_online_unigram2 /1.0 /Y_test.shape[0]
    print "error_rate_online_unigram2", error_rate_online_unigram2
    fp = open("error_rate_online_unigram2.txt", 'w')
    fp.write('error_rate_online_unigram2')
    fp.write('\n')
    fp.write(str(error_rate_online_unigram2))
    fp.close()
