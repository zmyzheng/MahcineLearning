...
This code shows unigram presentation and Online Perceptron(2 passes)
...
def onlinePerceptron(data, labels):
    '''
    This function realize online Perceptron
    '''
...
if __name__== "__main__":
   ...
   # unigram presentation
    ...
    for i in range(K):
        ...
        w = onlinePerceptron(X_train, Y_train)
    ...
    error_number_online_unigram1 = np.mean(np.array(error_number1))
    error_rate_online_unigram1 = error_number_online_unigram1 /1.0 /Y_test.shape[0]
    print "error_rate_online_unigram1", error_rate_online_unigram1
    fp = open("error_rate_online_unigram1.txt", 'w')
    fp.write('error_rate_online_unigram1')
    fp.write('\n')
    fp.write(str(error_rate_online_unigram1))
    fp.close()
